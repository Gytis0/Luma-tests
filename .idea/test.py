...
class LumaTests(unittest.TestCase):
    ...
    def test_scenario_1(self):
        ...
        placeOrderButton = driver.find_element(By.XPATH, "//*[@class='action primary checkout']")
        placeOrderButton.click()

        try:
            doesExist = WebDriverWait(driver, 10).until(
                EC.visibility_of_element_located((By.XPATH, "//*[@class='base']"))
            )
        except:
            print("Fields are not visible")

        self.assertEqual("Thank you for your purchase!", driver.find_element(By.XPATH, "//*[@class='base']").text)
